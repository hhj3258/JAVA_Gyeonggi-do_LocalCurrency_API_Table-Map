...
public class MainC extends JFrame 
{
	...
	private void loadWebData() {
		...
		NodeList INDUTYPE_NM=res.getElementsByTagName("INDUTYPE_NM");					//업종명INDUTYPE_NM
		NodeList REFINE_ROADNM_ADDR=res.getElementsByTagName("REFINE_ROADNM_ADDR");		//도로명주소REFINE_ROADNM_ADDR
		NodeList TELNO=res.getElementsByTagName("REFINE_ZIP_CD");								//전화번호TELNO
		NodeList DATA_STD_DE=res.getElementsByTagName("DATA_STD_DE");					//데이터 기준 일자DATA_STD_DE
		NodeList REFINE_WGS84_LAT=res.getElementsByTagName("REFINE_WGS84_LAT");			//위도REFINE_WGS84_LAT
		NodeList REFINE_WGS84_LOGT=res.getElementsByTagName("REFINE_WGS84_LOGT");		//경도REFINE_WGS84_LOGT
